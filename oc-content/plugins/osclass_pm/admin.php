<?php if (!defined('OC_ADMIN') || OC_ADMIN==false) exit('Access is not allowed.');?>
<?php
...
<form action="<?php osc_admin_base_url(true); ?>" method="post">
    ...
    <fieldset>
        ...
        <br />
        <br />
        <?php /* This is for future version once I get the drafts working.
        ...
        <select name="deletePM" id="deletePM"> 
        	...
        	<option <?php if($deletePM == 0){echo 'selected="selected"';}?>value='0'><?php _e('Never','osclass_pm');?></option>
        </select>
        <br />
        <br />
        </fieldset>
