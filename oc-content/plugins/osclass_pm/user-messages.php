...
<div class="content user_account">
    <div id="main">
      <?php if(Params::getParam('box') == 'inbox') { ?>
         <a href="<?php echo osc_base_url(true) . '?page=custom&file=osclass_pm/user-inbox.php'; ?>">Return to Received messages</a>
      <?php } elseif(Params::getParam('box') == 'outbox') { ?>
         <a href="<?php echo osc_base_url(true) . '?page=custom&file=osclass_pm/user-outbox.php'; ?>">Return to Sent messages</a>
      <?php } ?> 
      <br />
      <br />
      <div class="pm_main">
            ...
            <div class="pm_tools">
               <div class="pm_sub">
                  ...
                  <?php echo __('Sent to: ','osclass_pm') . $user['s_name'] . ' ' . __('on: ','osclass_pm') . osc_format_date($pm['message_date']) . ', ' . osclass_pm_format_time($pm['message_date']); ?>
                     ...
                     <?php if(Params::getParam('box') == 'outbox') { ?>
      <?php } elseif(Params::getParam('box') == 'inbox') { ?>
