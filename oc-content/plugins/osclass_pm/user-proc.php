...
switch(Params::getParam('option')){
   ...
   break;
   case 'send':
      $thread_id  = Params::getParam('threadId');
      ...
      switch(Params::getParam('box')) {
         case 'reply':
            ...
            ModelPM::newInstance()->insertMessage($thread_id,$sender_id, $recip_id, $subject, $message, $saveOutbox);
         ...
         case 'adminQuote':
            ...
            if (stripos($subject,'Odgovor za:') === false) {
               $subject = 'Odgovor za: ' . $subject;
            }
            ModelPM::newInstance()->insertMessage($sender_id, $recip_id, $subject, $message, $saveOutbox);
