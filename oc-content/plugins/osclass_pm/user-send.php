<?php
       ...
       $threadId = Params::getParam('threadId');
        ...
        <form id="newMessage-form" action="<?php echo osc_base_url('oc-content/plugins/osclass_pm/user-proc.php') ; ?>" method="POST">
            ...
            <div class="pm_main">
                ...
                <div class="pm_message">
                    ...
                    ?>
                    <div class="pm_mess">
                        <h4><?php echo  $pm['pm_subject']; ?></h4>
                        <p><?php echo __('From:','osclass_pm') . ' ' . $user['s_name'] . ' ' . __('on: ','osclass_pm') . osc_format_date($pm['message_date']) . ', ' . osclass_pm_format_time($pm['message_date']); ?></p>
                        <p id="replyMess">
                    ...
                    <div class="pm_tools">
                        <table>
                            ...
                            <tr class="subject">
                                ...
                                <td><input tabindex="2" type="text" maxlength="60" size="60" name="subject" id="subject" value="<?php if(@$item != ''){echo '' . @$item['s_title'];}elseif($mType == 'reply' || $mType == 'quote'){echo $pm['pm_subject'];}else{ _e('[No subject]','osclass_pm');} ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    <div class="pm_mess">
