...
<div class="row">
    <div class="col-sm-4 col-md-3">
        <div class="title">
            <h1>
                <?php _e('User profile', 'osclasswizards'); ?>
            </h1>
        </div>
        <div class="user-card">
            ...
            <ul id="user_data">
                ...
                <?php if( $address !== '' ) { ?>
                <li class="adress">
                    <strong><?php _e('Address', 'osclasswizards');?>: </strong>
                    <?php printf(__('%1$s'), $address); ?></li>
                <?php } ?>
                <?php if( $location !== '' ) { ?>
                <li class="location">
                    <strong><?php
                        _e('Location', 'osclasswizards');
                        ?>: </strong>
                    <?php
                        printf(__('%1$s'), $location);
                    ?></li>
                <?php } ?>
            </ul>
        </div>
    ...
    <div class="col-sm-8 col-md-9">
        ...
        <div class="similar_ad">
            <div class="title">
                <h1>
                    <?php _e('Published listings', 'osclasswizards'); ?>
                </h1>
            </div>
