...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../../../' . str_replace(osc_base_path(), '', osc_uploads_path()) . 'page-images/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../../../' . str_replace(osc_base_path(), '', osc_uploads_path()) . 'page-images/'); //accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 5048); //by bytes
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf');
	//define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt'); //
	...
	define('CONFIG_WEBSITE_DOCUMENT_ROOT', dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))))));
